...
<body  style="width: 100%; height: 100%; background: url('img/bg-5.jpg') no-repeat; background-size: cover;">
		...
		<form class="bs-example bs-example-form" role="form">
			<div class="input-group">
				<span class="input-group-addon"><i
					...
					class="form-control" id="username" name="username" placeholder="请输入账户"/>
			</div>
			<br>
			<div class="input-group">
				<span class="input-group-addon"><i
			...
			<div style="margin: auto; width: 82px; height: 34px;">
				<button type="button" id="login" class="btn btn-primary">立即登陆</button>
			</div>
			<p id="err" style="color: red;text-align: center;"></p>
			<p style="text-align: center;">已有账户？点击<a href="register.html">注册</a></p>
		</form>
	</div>
